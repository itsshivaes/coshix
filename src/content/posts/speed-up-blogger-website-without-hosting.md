...
You can identify fast-loading templates by using any page speed checker website. The most commonly used websites for checking page speed are [PageSpeed Insights](https://pagespeed.web.dev/) and [GTmetrics](https://gtmetrix.com/).
...
Minifying is the process that makes CSS or JavaScript smaller than before. Minified CSS or JavaScript is a little harder to read, but it helps to improve website speed. The commonly used websites for minifying JavaScript and CSS are [minifier.org](https://www.minifier.org/), [Toptal JavaScript Minifier](https://www.toptal.com/developers/javascript-minifier), and [Toptal CSS Minifier](https://www.toptal.com/developers/cssminifier).
...
3.  Click on the drop-down icon near orange colored **Customize** button
4.  Click **Edit HTML**
5.  Add `b:css='false'` in the first HTML tag

![Screenshot](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjoKunInjSf_RelA1y8SCkmi3YnuVwv2PB_yLjL97rvgGc-cvS9-Pa0zuw3Z5SwFivM7jkHiWcuDwqCKY1TsvvdwRxYCPbl1cAZ_X_r-_QnVU_xQQG5dB4iitMaPn9FGabEfudhb2DoI-OMMhUAtA3OQWYcTCddm9sdSObm63N8apTgPOAJZWjPK0sjIJbe/s600-rw/Untitled.webp)
...
To use it, you just need to add `async='async'` In the open script tag example given below:

```
<script src='example.js' async='async'/>
```
